...
/datum/controller/subsystem/vsociety/proc/poll_for_prince()
	...
	var/icon/prince_icon = icon('modular_oculis/modules/vampires/icons/vampiric.dmi', "prince")
...
/datum/antagonist/vampire/proc/princify()
	...
	owner.current.playsound_local(null, 'modular_oculis/modules/vampires/sound/prince.ogg', 100, FALSE, pressure_affected = FALSE)
	prince = TRUE
...
/datum/antagonist/vampire/proc/scourgify()
	...
	owner.current.playsound_local(null, 'modular_oculis/modules/vampires/sound/scourge_recruit.ogg', 100, FALSE, pressure_affected = FALSE)
	scourge = TRUE
	add_team_hud(owner.current)
