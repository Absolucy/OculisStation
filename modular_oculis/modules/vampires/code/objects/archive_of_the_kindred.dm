 ...
 *	This book should not work on Vampires using the Feign Life ability.
...
/obj/item/book/kindred
	...
	icon = 'modular_oculis/modules/vampires/icons/vamp_obj.dmi'
	lefthand_file = 'modular_oculis/modules/vampires/icons/bs_leftinhand.dmi'
	righthand_file = 'modular_oculis/modules/vampires/icons/bs_rightinhand.dmi'
...
/obj/item/book/kindred/interact_with_atom(mob/target, mob/living/user, list/modifiers)
	...
	if(vampiredatum && !HAS_TRAIT(target, TRAIT_FEIGN_LIFE))
