...
/datum/action/antag_info/vampire
	name = "Vampire Guide"
	background_icon = 'modular_oculis/modules/vampires/icons/actions_vampire.dmi'
...
/datum/antagonist/vampire/proc/on_examine(datum/source, mob/examiner, list/examine_text)
	...
	var/text
	if(prince)
		text = "<img class='icon' src='\ref['modular_oculis/modules/vampires/icons/vampiric.dmi']?state=prince'> "
	else if(scourge)
		text = "<img class='icon' src='\ref['modular_oculis/modules/vampires/icons/vampiric.dmi']?state=scourge'> "
	else
