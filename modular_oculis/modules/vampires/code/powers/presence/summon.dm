...
/datum/action/cooldown/vampire/targeted/summon
	...
	ranged_mousepointer = 'modular_oculis/modules/vampires/icons/mouse_pointers/vampire_summon.dmi'
...
/datum/action/cooldown/vampire/targeted/summon/fire_targeted_power(atom/target_atom)
	...
	carbon_target.playsound_local(null, 'modular_oculis/modules/vampires/sound/mesmerize.ogg', 70, FALSE, pressure_affected = FALSE)
