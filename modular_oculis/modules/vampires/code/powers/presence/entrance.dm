...
/datum/action/cooldown/vampire/targeted/entrance
	...
	ranged_mousepointer = 'modular_oculis/modules/vampires/icons/mouse_pointers/vampire_entrance.dmi'
...
/datum/action/cooldown/vampire/targeted/entrance/fire_targeted_power(atom/target_atom)
	...
	carbon_target.playsound_local(null, 'modular_oculis/modules/vampires/sound/mesmerize.ogg', 50, FALSE, pressure_affected = FALSE)
