...
/datum/action/cooldown/vampire/targeted/mesmerize
	...
	level_current = 1
	ranged_mousepointer = 'modular_oculis/modules/vampires/icons/mouse_pointers/vampire_mesmerize.dmi'
...
/datum/status_effect/mesmerized/on_apply()
	...
	owner.playsound_local(null, 'modular_oculis/modules/vampires/sound/mesmerize.ogg', 100, FALSE, pressure_affected = FALSE)
	return TRUE
