...
/datum/action/cooldown/vampire/targeted/feed
	...
	ranged_mousepointer = 'modular_oculis/modules/vampires/icons/mouse_pointers/vampire_feed.dmi'
...
/datum/action/cooldown/vampire/targeted/feed/fire_targeted_power(atom/target_atom)
	...
	if(!living_owner.combat_mode)
		...
		feed_target.playsound_local(null, 'modular_oculis/modules/vampires/sound/mesmerize.ogg', 100, FALSE, pressure_affected = FALSE)
		...
		living_owner.playsound_local(null, 'modular_oculis/modules/vampires/sound/drinkblood1.ogg', 100, FALSE, pressure_affected = FALSE)
		...
		playsound(living_owner, 'modular_oculis/modules/vampires/sound/drinkblood1.ogg', 50)
