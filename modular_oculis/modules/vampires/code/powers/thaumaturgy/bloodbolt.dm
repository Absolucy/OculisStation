/datum/action/cooldown/vampire/targeted/bloodbolt
	...
	ranged_mousepointer = 'modular_oculis/modules/vampires/icons/mouse_pointers/vampire_bloodbolt.dmi'
...
/datum/action/cooldown/vampire/targeted/bloodbolt/fire_targeted_power(atom/target_atom)
	...
	playsound(living_owner, 'modular_oculis/modules/vampires/sound/bloodbolt_fire.ogg', 60, TRUE)
...
/obj/projectile/magic/arcane_barrage/vampire
	...
	damage = 40
	hitsound = 'modular_oculis/modules/vampires/sound/bloodbolt.ogg'
